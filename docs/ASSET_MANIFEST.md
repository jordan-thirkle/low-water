...
| `public/assets/generated/low-water-player.png` | Project-specific image-generation pass in this workspace | Provider terms must be checked against the intended commercial release before shipping | Player sprite | Chroma-key background removed locally; RGBA |
| `public/assets/generated/low-water-crow.png` | Project-specific image-generation pass in this workspace | Provider terms must be checked against the intended commercial release before shipping | Hazard sprite | Chroma-key background removed locally; RGBA |
| `public/assets/generated/low-water-key.png` | Project-specific image-generation pass in this workspace | Provider terms must be checked against the intended commercial release before shipping | Found-object sprite | Chroma-key background removed locally; RGBA |
